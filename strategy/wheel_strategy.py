...
class WheelStrategy:
    ...
    def _try_take_profit(self, pos, profit_threshold: float = 0.50) -> bool:
        ...
        v6 expiry-aware override: if option is near worthless (<= $0.15) AND
        within 2 days of expiry, SKIP the BTC and let it expire OTM. Reason:
          ...
          - v6.1: expanded from DTE<=1/$0.10 to DTE<=2/$0.15 — last 2 days
            of a 3-5 DTE put are deep theta-decay territory; reversal risk
            is negligible and bid-ask spread typically exceeds the premium
